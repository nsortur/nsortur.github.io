...
My current research interests involve transparent machine learning in physical systems for inverse design, decision-making, and dynamics modeling. I'm looking for PhD programs to first build tools that can scrutinize the robustness of existing models, then use these tools as a platform for more theoretical work in embodied intelligence. 
